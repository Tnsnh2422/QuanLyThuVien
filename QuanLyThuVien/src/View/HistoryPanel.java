...
public class HistoryPanel extends javax.swing.JPanel {
    ...
    private void showData(){
        try {
            ...
            String querry = "SELECT * FROM [dbo].[lichsu]";
    ...
    private void btn_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchActionPerformed
        ...
        DataValidator.validateEmpty(txt_searchHistory, sb, "Mã Sinh Viên không được để trống");
        if (sb.length()>0) {
            MessageDialogHelper.showErrorDialog(formAdmin, "Lỗi", sb.toString());
        }else{
        try {
            String id = (String) txt_searchHistory.getText();
            DAOBorrowBook dao = new DAOBorrowBook();
            BorrowBook timKiem = dao.lichSu(id);
        } catch (Exception e) {
