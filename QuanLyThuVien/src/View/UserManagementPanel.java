...
public class UserManagementPanel extends javax.swing.JPanel {
    ...
    private void showData(){
        try {
            ...
            String[] arr = {"tenDangNhap", "MatKhau", "MaSV", "hoTen", "email", "gioitinh", "diachi"};
    ...
    private void initComponents() {
        ...
        txt_account.setText("user3");

        txt_password.setText("123");

        txt_name.setText("Nguyễn Đức Việt");

        txt_MaSV.setText("AT170754");
        ...
        txt_email.setText("vietlcvn123@gmail.com");

        txt_Address.setColumns(20);
        txt_Address.setRows(5);
        txt_Address.setText("Lào Cai");
        jScrollPane1.setViewportView(txt_Address);

        btn_reset.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        btn_reset.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hinhNen/Icon/undo.png"))); // NOI18N
